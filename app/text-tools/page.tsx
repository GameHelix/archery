        ...
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-6 lg:gap-8">
              ...
              <div className="mb-8">
                ...
                <div className="relative">
                  <textarea
                    ...
                    className="w-full px-4 py-3 border border-dark-600 rounded-xl bg-dark-800 text-gray-100 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-purple-500 resize-vertical transition-all duration-200 text-sm sm:text-base"
                  />
                  {inputText && (
                  ...
                  {[
                    ...
                    return (
                      <div key={index} className={`rounded-xl p-4 sm:p-6 border-2 transition-all duration-200 hover:shadow-md ${item.color}`}>
                        ...
                        <div className="text-sm text-gray-100 bg-dark-800 p-3 rounded-lg border min-h-[80px] font-mono break-all overflow-hidden">
                          {result || (
                    ...
                    <div className="bg-gradient-to-r from-indigo-50 to-purple-50 rounded-xl p-6 border border-indigo-200">
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-center">
                        ...
                        <div className="bg-white rounded-lg p-4 shadow-sm">
                          ...
                          <div className="text-xs text-gray-400">Including spaces</div>
                        </div>
                        <div className="bg-white rounded-lg p-4 shadow-sm">
                          ...
                          <div className="text-xs text-gray-400">Characters per word</div>
                        </div>
                      </div>
                    </div>
                  )}
                  ...
                  {[
                    ...
                    return (
                      <div key={index} className={`rounded-xl p-4 sm:p-6 border-2 transition-all duration-200 hover:shadow-md ${item.color}`}>
                        ...
                        <div className="text-sm text-gray-100 bg-dark-800 p-3 rounded-lg border min-h-[120px] font-mono whitespace-pre-wrap break-all overflow-hidden">
                          {result || (
                            <span className="text-gray-400 italic">
                              {inputText ? 'Processing...' : 'Enter text to see result...'}
                            </span>
          ...
          <div className="xl:col-span-1 space-y-6">
            ...
            <div className="bg-gradient-to-br from-green-500/20 to-emerald-500/20 rounded-2xl p-6 border border-green-500/30">
              <h3 className="text-lg font-semibold text-green-300 mb-4">Available Tools</h3>
