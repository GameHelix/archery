                      ...
                      <button
                        ...
                        className={`p-3 rounded-xl border-2 transition-all duration-200 text-sm ${
                          saltRounds === option.value
                            ...
                            : 'border-dark-700 bg-dark-800 hover:border-red-300 hover:bg-red-500/20 text-gray-300'
                        }`}
                      >
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full px-4 py-3 pr-12 border border-dark-600 rounded-xl bg-dark-800 text-gray-100 placeholder-gray-500 focus:ring-2 focus:ring-red-500 focus:border-red-500 transition-colors"
                    />
                    <button
                      onClick={() => setShowPasswords(!showPasswords)}
                      className="absolute right-3 top-1/2 transform -translate-y-1/2 p-1 text-gray-400 hover:text-gray-400 rounded-lg transition-colors"
                    >
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 border border-dark-600 rounded-xl bg-dark-800 text-gray-100 placeholder-gray-500 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors"
                  />
                </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={3}
                    className="w-full px-4 py-3 border border-dark-600 rounded-xl bg-dark-800 text-gray-100 placeholder-gray-500 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors resize-none"
                  />
                </div>
              ...
              <div className="bg-dark-card backdrop-blur-sm rounded-2xl shadow-xl border border-dark-700 hover:border-primary-500/50 transition-all duration-300 p-6 sm:p-8">
                ...
                <div className="space-y-4">
                  {generatedHashes.map((hashResult) => (
                    <div key={hashResult.id} className="p-4 bg-dark-800 rounded-xl border border-dark-700">
                      ...
                      <div className="space-y-2">
                        <div>
                          <label className="block text-xs font-medium text-gray-400 mb-1">Original Password:</label>
                          <div className="flex items-center justify-between p-2 bg-dark-800 rounded border">
                        ...
                        <div>
                          <label className="block text-xs font-medium text-gray-400 mb-1">Bcrypt Hash:</label>
                          <div className="flex items-center justify-between p-2 bg-dark-800 rounded border">
          ...
          <div className="xl:col-span-1 space-y-6">
            ...
            <div className="bg-dark-card backdrop-blur-sm rounded-2xl shadow-xl border border-dark-700 hover:border-primary-500/50 transition-all duration-300 p-6">
              ...
              <div className="space-y-3 text-sm text-gray-300">
                <div>
                  <div className="font-medium text-white">4-8 Rounds:</div>
                  <div className="text-gray-400">Fast but less secure. Good for development.</div>
                </div>
                <div>
                  <div className="font-medium text-white">10-12 Rounds:</div>
                  <div className="text-gray-400">Balanced security and performance. Recommended for production.</div>
                </div>
                <div>
                  <div className="font-medium text-white">14-16 Rounds:</div>
                  <div className="text-gray-400">Maximum security but slower. Use for highly sensitive data.</div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-orange-500/20 to-red-500/20 rounded-2xl p-6 border border-orange-500/30">
              <h3 className="text-lg font-semibold text-orange-300 mb-4">Best Practices</h3>
              <div className="space-y-3 text-sm text-gray-300">
                <div>
                  <div className="font-medium mb-1">Never store plain passwords:</div>
                  <div className="text-xs text-orange-400">Always hash passwords before storage</div>
                </div>
                <div>
                  <div className="font-medium mb-1">Use appropriate salt rounds:</div>
                  <div className="text-xs text-orange-400">Balance security with performance needs</div>
                </div>
                <div>
                  <div className="font-medium mb-1">Regular security updates:</div>
                  <div className="text-xs text-orange-400">Monitor and update hashing strategies</div>
                </div>
              </div>
            </div>
          </div>
