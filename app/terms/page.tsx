      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="bg-dark-800 rounded-xl shadow-lg p-8 sm:p-12 border border-dark-600">
          <div className="text-center mb-8">
            ...
            <p className="text-lg text-gray-300">Usage guidelines and legal terms</p>
          ...
          <div className="prose prose-gray max-w-none">
            ...
            <section className="mb-8">
              ...
              <h3 className="text-xl font-semibold text-gray-100 mb-3">You MAY:</h3>
              ...
              <h3 className="text-xl font-semibold text-gray-100 mb-3">You MAY NOT:</h3>
              <ul className="list-disc pl-6 text-gray-200 mb-4 space-y-1">
            ...
            <section className="mb-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                <div className="bg-green-900 border border-green-700 rounded-lg p-4">
                  <h3 className="text-lg font-semibold text-green-100 mb-2">What We Provide</h3>
                ...
                <div className="bg-yellow-900 border border-yellow-700 rounded-lg p-4">
                  <h3 className="text-lg font-semibold text-yellow-100 mb-2">Service Limitations</h3>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-200 mb-4">As a user of SwissKnife, you are responsible for:</p>
              <ul className="list-disc pl-6 text-gray-200 mb-4 space-y-1">
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc pl-6 text-gray-200 mb-4 space-y-1">
                ...
                <li>See our <a href="/privacy" className="text-primary-400 hover:text-primary-300 underline">Privacy Policy</a> for complete details</li>
              </ul>
            </section>
            ...
            <section className="mb-8">
              ...
              <h3 className="text-xl font-semibold text-gray-100 mb-3">Accuracy of Results</h3>
              <p className="text-gray-200 mb-4">
              ...
              <h3 className="text-xl font-semibold text-gray-100 mb-3">Third-Party Content</h3>
              <p className="text-gray-200 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-white mb-4">Modifications to Service and Terms</h2>
              <p className="text-gray-200 mb-4">
