...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-dark-primary">
      ...
      <main>
        {/* Hero Section */}
        <section className="relative bg-gradient-to-br from-dark-950 via-dark-900 to-dark-800 text-white overflow-hidden border-b border-dark-700/50">
          {/* Background Pattern */}
          <div className="absolute inset-0 opacity-10">
            <div className="absolute inset-0" style={{
              backgroundImage: `url("data:image/svg+xml,%3Csvg width='60' height='60' viewBox='0 0 60 60' xmlns='http://www.w3.org/200/svg'%3E%3Cg fill='none' fill-rule='evenodd'%3E%3Cg fill='%23ffffff' fill-opacity='0.1'%3E%3Ccircle cx='30' cy='30' r='2'/%3E%3C/g%3E%3C/g%3E%3C/svg%3E")`,
            }} />
          </div>
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20 lg:py-28">
            <div className="text-center">
              ...
              <div className="flex justify-center mb-6">
                <div className="w-20 h-20 sm:w-24 sm:h-24 bg-gradient-to-br from-primary-500/20 to-primary-700/20 backdrop-blur-sm rounded-3xl flex items-center justify-center animate-fade-in shadow-2xl shadow-primary-500/20 border border-primary-500/30">
              ...
              <h2 className="text-lg sm:text-xl lg:text-2xl mb-6 sm:mb-8 text-gray-300 max-w-4xl mx-auto animate-slide-up font-medium leading-relaxed px-4">
                Your ultimate collection of essential online tools. Fast, secure, and completely free.
              </h2>

              <p className="text-sm sm:text-base text-gray-400 mb-8 sm:mb-10 max-w-2xl mx-auto animate-slide-up px-4">
              ...
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center items-stretch sm:items-center px-4 animate-slide-up max-w-lg sm:max-w-none mx-auto">
                <Link
                  href="#tools"
                  className="w-full sm:w-auto bg-gradient-to-r from-white to-gray-100 text-dark-900 hover:from-gray-100 hover:to-gray-200 active:from-gray-200 active:to-gray-300 hover:scale-105 active:scale-95 transition-all duration-200 inline-flex items-center justify-center px-6 sm:px-8 py-4 text-base sm:text-lg font-semibold rounded-xl shadow-lg hover:shadow-2xl hover:shadow-white/20 touch-manipulation"
                >
                ...
                <Link
                  href="/password-generator"
                  className="w-full sm:w-auto bg-gradient-to-r from-primary-600 to-primary-700 hover:from-primary-500 hover:to-primary-600 active:from-primary-700 active:to-primary-800 text-white border-2 border-primary-500/50 hover:border-primary-400 hover:scale-105 active:scale-95 transition-all duration-200 inline-flex items-center justify-center px-6 sm:px-8 py-4 text-base sm:text-lg font-semibold rounded-xl shadow-lg hover:shadow-2xl hover:shadow-primary-500/50 touch-manipulation"
                >
                  <svg className="w-4 h-4 sm:w-5 sm:h-5 mr-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="grid grid-cols-3 gap-4 sm:gap-8 max-w-lg mx-auto mt-12 sm:mt-16 px-4">
                <div className="text-center group">
                  <div className="text-2xl sm:text-3xl lg:text-4xl font-bold bg-gradient-to-r from-primary-400 to-primary-300 bg-clip-text text-transparent group-hover:from-primary-300 group-hover:to-primary-200 transition-all">20</div>
                  <div className="text-xs sm:text-sm text-gray-400">Active Tools</div>
                </div>
                <div className="text-center group">
                  <div className="text-2xl sm:text-3xl lg:text-4xl font-bold bg-gradient-to-r from-green-400 to-green-300 bg-clip-text text-transparent group-hover:from-green-300 group-hover:to-green-200 transition-all">100%</div>
                  <div className="text-xs sm:text-sm text-gray-400">Free</div>
                </div>
                <div className="text-center group">
                  <div className="text-2xl sm:text-3xl lg:text-4xl font-bold bg-gradient-to-r from-purple-400 to-purple-300 bg-clip-text text-transparent group-hover:from-purple-300 group-hover:to-purple-200 transition-all">0</div>
                  <div className="text-xs sm:text-sm text-gray-400">Registration</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="absolute bottom-0 left-0 right-0">
            <svg className="w-full h-4 sm:h-6 lg:h-8 text-dark-primary" viewBox="0 0 1200 120" preserveAspectRatio="none">
        ...
        {/* Features Section */}
        <section className="py-12 sm:py-16 lg:py-20 bg-dark-primary relative border-b border-dark-700/50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 lg:gap-10">
              <div className="group text-center p-6 sm:p-8 bg-gradient-to-br from-dark-card to-dark-800 rounded-2xl border border-dark-700 hover:border-green-500/50 hover:shadow-2xl hover:shadow-green-500/20 transition-all duration-300 transform hover:-translate-y-1">
                <div className="w-16 h-16 sm:w-20 sm:h-20 bg-gradient-to-br from-green-500/20 to-green-600/20 rounded-2xl flex items-center justify-center mx-auto mb-4 sm:mb-6 group-hover:scale-110 transition-transform duration-300 border border-green-500/30">
                ...
                <h3 className="text-lg sm:text-xl font-bold text-white mb-3 sm:mb-4">Completely Free</h3>
                <p className="text-sm sm:text-base text-gray-400 leading-relaxed">All tools are free to use with no hidden costs, subscriptions, or premium features.</p>
              </div>

              <div className="group text-center p-6 sm:p-8 bg-gradient-to-br from-dark-card to-dark-800 rounded-2xl border border-dark-700 hover:border-blue-500/50 hover:shadow-2xl hover:shadow-blue-500/20 transition-all duration-300 transform hover:-translate-y-1">
                <div className="w-16 h-16 sm:w-20 sm:h-20 bg-gradient-to-br from-blue-500/20 to-blue-600/20 rounded-2xl flex items-center justify-center mx-auto mb-4 sm:mb-6 group-hover:scale-110 transition-transform duration-300 border border-blue-500/30">
                ...
                <h3 className="text-lg sm:text-xl font-bold text-white mb-3 sm:mb-4">Privacy First</h3>
                <p className="text-sm sm:text-base text-gray-400 leading-relaxed">Your data is processed locally in your browser. We don't store or share your information.</p>
              </div>

              <div className="group text-center p-6 sm:p-8 bg-gradient-to-br from-dark-card to-dark-800 rounded-2xl border border-dark-700 hover:border-purple-500/50 hover:shadow-2xl hover:shadow-purple-500/20 transition-all duration-300 transform hover:-translate-y-1 sm:col-span-2 lg:col-span-1">
                <div className="w-16 h-16 sm:w-20 sm:h-20 bg-gradient-to-br from-purple-500/20 to-purple-600/20 rounded-2xl flex items-center justify-center mx-auto mb-4 sm:mb-6 group-hover:scale-110 transition-transform duration-300 border border-purple-500/30">
                ...
                <h3 className="text-lg sm:text-xl font-bold text-white mb-3 sm:mb-4">Mobile Friendly</h3>
                <p className="text-sm sm:text-base text-gray-400 leading-relaxed">All tools work perfectly on desktop, tablet, and mobile devices with responsive design.</p>
              </div>
            </div>
          </div>
        </section>
        ...
        {/* Tools Grid */}
        <section id="tools" className="py-12 sm:py-16 lg:py-20 bg-gradient-to-br from-dark-secondary to-dark-primary border-b border-dark-700/50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12 sm:mb-16">
              <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-white mb-4 sm:mb-6">
                Essential Tools
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 sm:gap-5 lg:gap-6">
              {tools.map((tool, index) => (
                <Link
                  key={tool.href}
                  href={tool.href}
                  className="group bg-gradient-to-br from-dark-card to-dark-800 rounded-2xl shadow-lg hover:shadow-2xl hover:shadow-primary-500/10 active:shadow-md border border-dark-700 hover:border-primary-500/50 active:border-primary-600 transition-all duration-300 transform hover:-translate-y-2 active:translate-y-0 p-5 sm:p-6 lg:p-8 animate-slide-up touch-manipulation"
                  style={{ animationDelay: `${index * 75}ms` }}
                >
                  <div className="flex items-center justify-center mb-4 sm:mb-5">
                    <div className={`w-12 h-12 sm:w-14 sm:h-14 lg:w-16 lg:h-16 ${tool.color} rounded-2xl flex items-center justify-center group-hover:scale-110 group-active:scale-95 group-hover:rotate-3 transition-all duration-300 shadow-lg shadow-black/50`}>
                      <tool.icon className="h-6 w-6 sm:h-7 sm:w-7 lg:h-8 lg:w-8 text-white" />
                    </div>
                  </div>
                  <h3 className="text-base sm:text-lg lg:text-xl font-bold text-white mb-2 sm:mb-3 text-center group-hover:text-primary-400 transition-colors duration-300 line-clamp-2">
                    {tool.name}
                  </h3>
                  <p className="text-sm sm:text-sm lg:text-base text-gray-400 text-center leading-relaxed line-clamp-3">
                    {tool.description}
                  </p>
            ...
            <div className="text-center mt-12 sm:mt-16">
              ...
              <Link
                href="/contact"
                className="inline-flex items-center px-6 py-3 text-sm sm:text-base font-semibold text-white bg-gradient-to-r from-primary-600 to-primary-700 hover:from-primary-500 hover:to-primary-600 rounded-xl shadow-lg hover:shadow-2xl hover:shadow-primary-500/30 border border-primary-500/50 hover:border-primary-400 hover:scale-105 transition-all duration-200"
              >
        ...
        <section className="py-16 sm:py-20 bg-dark-primary border-b border-dark-700/50">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div className="bg-gradient-to-br from-red-500/10 to-red-600/10 rounded-2xl p-6 border border-red-500/30 hover:border-red-500/50 transition-all duration-300 shadow-2xl shadow-black/50 hover:shadow-red-500/20">
                ...
                <h3 className="text-xl font-bold text-white mb-3">Password Security 101</h3>
              ...
              <div className="bg-gradient-to-br from-blue-500/10 to-blue-600/10 rounded-2xl p-6 border border-blue-500/30 hover:border-blue-500/50 transition-all duration-300 shadow-2xl shadow-black/50 hover:shadow-blue-500/20">
                ...
                <h3 className="text-xl font-bold text-white mb-3">QR Code Guidelines</h3>
                <p className="text-gray-300 mb-4 leading-relaxed">
              ...
              {/* Privacy Tips */}
              <div className="bg-gradient-to-br from-green-500/10 to-green-600/10 rounded-2xl p-6 border border-green-500/30 hover:border-green-500/50 transition-all duration-300 shadow-2xl shadow-black/50 hover:shadow-green-500/20">
        ...
        <section className="py-16 sm:py-20 bg-dark-secondary border-b border-dark-700/50">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl sm:text-4xl font-bold text-white mb-4">
            ...
            <div className="bg-dark-card rounded-2xl shadow-2xl shadow-black/50 overflow-hidden border border-dark-700">
                ...
                <table className="w-full">
                  ...
                  <tbody className="divide-y divide-dark-700">
                    <tr className="bg-dark-800">
                      <td className="px-6 py-4 font-medium text-white">Privacy Protection</td>
                    ...
                    <tr className="bg-dark-800">
                      <td className="px-6 py-4 font-medium text-white">Speed</td>
                      <td className="px-6 py-4 text-center">
                        <span className="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-green-500/20 text-green-400 border border-green-500/30">
                          ✓ Instant processing
                        </span>
                    ...
                    <tr className="bg-dark-900/50">
                      <td className="px-6 py-4 font-medium text-white">Registration</td>
                      <td className="px-6 py-4 text-center">
                        <span className="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-green-500/20 text-green-400 border border-green-500/30">
                          ✓ No signup required
                        </span>
        ...
        {/* FAQ Section */}
        <section className="py-16 sm:py-20 bg-dark-primary">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="space-y-6">
              {[
                ...
                <div key={index} className="bg-dark-card rounded-2xl p-6 border border-dark-700 hover:border-primary-500/50 transition-all duration-300 shadow-2xl shadow-black/50 hover:shadow-primary-500/20">
