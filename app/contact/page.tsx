  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            <div className="bg-white rounded-xl shadow-lg p-6 sm:p-8">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-gray-600">contact@swissknife.site</p>
                </div>
              ...
              <div className="mt-8 p-4 bg-blue-50 border border-blue-200 rounded-lg">
                <h3 className="text-lg font-semibold text-blue-800 mb-2">What can you contact us about?</h3>
        ...
        {/* Additional Info */}
        <div className="mt-8 bg-dark-800 rounded-xl shadow-lg p-6 sm:p-8">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">Frequently Asked Questions</h2>
          
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <h3 className="text-lg font-semibold text-gray-800 mb-2">Are your tools really free?</h3>
            ...
            <div>
              <h3 className="text-lg font-semibold text-gray-800 mb-2">Do you store my data?</h3>
              <p className="text-gray-600 text-sm">
            ...
            <div>
              <h3 className="text-lg font-semibold text-gray-800 mb-2">Can I suggest new tools?</h3>
              <p className="text-gray-600 text-sm">
