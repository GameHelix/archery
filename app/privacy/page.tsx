      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="bg-white rounded-xl shadow-lg p-8 sm:p-12">
          <div className="text-center mb-8">
            ...
            <p className="text-lg text-gray-600">Your privacy is our priority</p>
          ...
          <div className="prose prose-gray max-w-none">
            <section className="mb-8">
              ...
              <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                <h3 className="text-lg font-semibold text-green-800 mb-2">🔒 Privacy-First Design</h3>
            ...
            <section className="mb-8">
              ...
              <h3 className="text-xl font-semibold text-gray-800 mb-3">Information We DON'T Collect:</h3>
            ...
            <section className="mb-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                  <h3 className="text-lg font-semibold text-blue-800 mb-2">Local Processing</h3>
                ...
                <div className="bg-purple-50 border border-purple-200 rounded-lg p-4">
                  <h3 className="text-lg font-semibold text-purple-800 mb-2">No Data Storage</h3>
